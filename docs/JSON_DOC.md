...
~~`intGrid`~~<br/><sup class="only">Only *IntGrid layers*</sup><br/><sup class="deprecated">*DEPRECATED!*</sup><br/> ![Generic badge](https://img.shields.io/badge/Removed_1.0.0-green.svg)  | Array&nbsp;of&nbsp;Object&nbsp;*(can&nbsp;be&nbsp;`null`)* | **WARNING**: this deprecated value is no longer exported since version 1.0.0<br/> <br/> Replaced by: `intGridCsv`
...
`__worldX`<br/> ![Generic badge](https://img.shields.io/badge/Added_1.3.4-gray.svg) ![Generic badge](https://img.shields.io/badge/Changed_1.5.0-gray.svg)  | Int&nbsp;*(can&nbsp;be&nbsp;`null`)* | X world coordinate in pixels. Only available in GridVania or Free world layouts.
`__worldY`<br/> ![Generic badge](https://img.shields.io/badge/Added_1.3.4-gray.svg) ![Generic badge](https://img.shields.io/badge/Changed_1.5.0-gray.svg)  | Int&nbsp;*(can&nbsp;be&nbsp;`null`)* | Y world coordinate in pixels Only available in GridVania or Free world layouts.
...
## 2.3.1. Reference to an Entity instance  ![Generic badge](https://img.shields.io/badge/Added_1.0.0-green.svg) 
...
## 2.3.2. Grid point  ![Generic badge](https://img.shields.io/badge/Added_1.0.0-green.svg) 
...
`uiFilterTags`<br/><sup class="internal">*Only used by editor*</sup><br/> ![Generic badge](https://img.shields.io/badge/Added_1.5.0-gray.svg)  | Array&nbsp;of&nbsp;String | Display tags
`useAsyncRender`<br/><sup class="only">Only *Tile layers, Auto-layers*</sup><br/><sup class="internal">*Only used by editor*</sup><br/> ![Generic badge](https://img.shields.io/badge/Added_1.5.0-gray.svg)  | Bool | Asynchronous rendering option for large/complex layers
~~`autoTilesetDefUid`~~<br/><sup class="only">Only *Auto-layers*</sup><br/><sup class="deprecated">*DEPRECATED!*</sup><br/>   | Int&nbsp;*(can&nbsp;be&nbsp;`null`)* | **WARNING**: this deprecated value will be *removed* completely on version 1.2.0+<br/> <br/> Replaced by: `tilesetDefUid`
...
`invalidated`<br/><sup class="internal">*Only used by editor*</sup><br/> ![Generic badge](https://img.shields.io/badge/Added_1.5.2-gray.svg)  | Bool | If TRUE, then the rule should be re-evaluated by the editor at one point
...
~~`tileIds`~~<br/><sup class="internal">*Only used by editor*</sup><br/><sup class="deprecated">*DEPRECATED!*</sup><br/>   | Array&nbsp;of&nbsp;Int&nbsp;*(can&nbsp;be&nbsp;`null`)* | **WARNING**: this deprecated value will be *removed* completely on version 1.5.0+<br/> <br/> Replaced by: `tileRectsIds`
...
`allowOutOfBounds`<br/><sup class="internal">*Only used by editor*</sup><br/> ![Generic badge](https://img.shields.io/badge/Added_1.5.0-gray.svg)  | Bool | If enabled, this entity is allowed to stay outside of the current level bounds
`doc`<br/><sup class="internal">*Only used by editor*</sup><br/> ![Generic badge](https://img.shields.io/badge/Added_1.2.5-gray.svg)  | String&nbsp;*(can&nbsp;be&nbsp;`null`)* | User defined documentation for this element to provide help/tips to level designers.
...
~~`tileId`~~<br/><sup class="deprecated">*DEPRECATED!*</sup><br/>   | Int&nbsp;*(can&nbsp;be&nbsp;`null`)* | **WARNING**: this deprecated value will be *removed* completely on version 1.2.0+<br/> <br/> Replaced by: `tileRect`
...
`allowedRefs`<br/><sup class="internal">*Only used by editor*</sup><br/> ![Generic badge](https://img.shields.io/badge/Added_1.0.0-green.svg)  | Enum | Possible values: `Any`, `OnlySame`, `OnlyTags`, `OnlySpecificEntity`
...
`exportToToc`<br/><sup class="internal">*Only used by editor*</sup><br/> ![Generic badge](https://img.shields.io/badge/Added_1.5.0-gray.svg)  | Bool | If TRUE, the field value will be exported to the `toc` project JSON field. Only applies to Entity fields.
`searchable`<br/><sup class="internal">*Only used by editor*</sup><br/> ![Generic badge](https://img.shields.io/badge/Added_1.5.0-gray.svg)  | Bool | If enabled, this field will be searchable through LDtk command palette
...
## 3.3.1. Tileset rectangle  ![Generic badge](https://img.shields.io/badge/Added_1.0.0-green.svg) 
